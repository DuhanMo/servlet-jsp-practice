...
<body>
	...
	<h3>7. 여러 값을 서버에 전송하고, 서버에서 리스트 출력하기</h3>
	...
	<h3>8. 서버로 기본 데이터 전송하고 맵 객체로 받아오기</h3>
	사용자 번호(,) : <input type="text" id="userIdx4"><br>
	<button id="testBtn8">ajax 결과확인</button>
	...
	<button id="selectBtn">ajax 결과 확인</button><br>
	...
	<h3>11. Gson을 이용한 List반환하기</h3>
	<button id="gsonListBtn">list 가져오기</button>
	<select id="gsonList"></select>
	<script>
	...
	<h3>12. Gson으로 Map 객체 전달받기</h3>
	<button id="gsonMapBtn">Map 가져오기</button>
	<select id="gsonMap"></select>
	<script>
